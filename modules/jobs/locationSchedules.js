...
exports.default = async (job) => {
    ...
    const response = await node_fetch_1.default(`${index_1.default.services.root}${index_1.default.services.locationsRoot}?fetchSchedule=true`, {
        headers: {
    ...
    for (const parkSchedule of responses) {
        const postResponse = await node_fetch_1.default(`${index_1.default.services.root}${index_1.default.services.locationsRoot}/${parkSchedule.id}/schedules`, {
