 ...
 */
exports.default = async (options = { locations: true, dining: true, activities: true }) => {
    ...
    if (options.locations) {
        try {
            ...
            const response = await node_fetch_1.default(`${index_1.default.services.root}${index_1.default.services.locationsRoot}`, {
